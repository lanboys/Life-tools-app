...
public class DragLayout extends ViewGroup {
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top,
                                          int dx, int dy) {
            LogUtil.i("DragLayout onViewPositionChanged");
            int childIndex = 1;
        ...
        public boolean tryCaptureView(View child, int pointerId) {
            // 两个子View都需要跟踪，返回true
            LogUtil.i("DragLayout tryCaptureView");
            //Tools.hideKeyboard();
            return true;
        }
        ...
        public int getViewVerticalDragRange(View child) {
            ...
            LogUtil.i("DragLayout getViewVerticalDragRange");
            return 1;
        }

        @Override
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            LogUtil.i("DragLayout onViewReleased");
        ...
        public int clampViewPositionVertical(View child, int top, int dy) {
            LogUtil.i("DragLayout clampViewPositionVertical" + "top=" + top + "=-------dy=" + dy);
            int finalTop = top;
            if (child == frameView1) {
                // 拖动的时第一个view
                if (top > 0) {
    ...
    private void onViewPosChanged(int viewIndex, int posTop) {
        LogUtil.i("DragLayout onViewPosChanged" + "viewIndex=" + viewIndex + "=-------posTop=" + posTop);
        if (viewIndex == 1) {
    ...
    public void toTop() {
        downTop1=1;
        animTopOrBottom(frameView1, 0);
        LogUtil.i("DragLayout toTop");
    }

    private void animTopOrBottom(View releasedChild, float yvel) {
        LogUtil.i("DragLayout animTopOrBottom");
        ...
        if (releasedChild == frameView1) {
            ...
            if (yvel < -VEL_THRESHOLD
                ...
                if (null != nextPageListener) {
                    ...
                    LogUtil.i("DragLayout animTopOrBottom1-1"+"frameView1.getTop()="+frameView1.getTop()+"-----downTop1="+downTop1+"======finalTop="+finalTop);
                }
            }
            LogUtil.i("DragLayout animTopOrBottom1"+"frameView1.getTop()="+frameView1.getTop()+"-----downTop1="+downTop1+"======finalTop="+finalTop);
        } else {
            // 拖动第二个view松手
            if (yvel > VEL_THRESHOLD
                ...
                // 保持原地不动
                finalTop = viewHeight;
                LogUtil.i("DragLayout animTopOrBottom2"+"finalTop="+finalTop+"======finalTop="+finalTop);
            }
        }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        LogUtil.i("DragLayout onLayout" + "l=" + l + "-------t=" + t + "-------r=" + r + "-------b=" + b);
