...
import static com.bing.lan.comm.view.SubmitEditTextInputLayout.RegExpType.TYPE_NO_TYPE;

public class SubmitEditTextInputLayout extends LinearLayout
    ...
    public SubmitEditTextInputLayout(Context context) {
        super(context);
        initView(context, null);
    }

    public SubmitEditTextInputLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initView(Context context, AttributeSet attrs) {
        inflate(context, R.layout.view_submit_input_layout, this);
    ...
    public void setRightImageMargins(int left, int top, int right, int bottom) {
        LayoutParams layoutParams = (LayoutParams) mIvImage.getLayoutParams();
